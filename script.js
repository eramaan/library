...
function displayLibrary(item) {
    if (item.read === true) {
        document.querySelector("#shelf").insertAdjacentHTML( "beforeend" , "<div class=\"book\"><p class=\"author\">" + item.author + "</p><p class=\"title\">" + item.title + "</p><p class=\"pages\">" + item.pages + "</p><div class=\"btn\"><button><span class=\"material-symbols-outlined\">visibility</span></button><button class=\"delete\"><span class=\"material-symbols-outlined\">delete</span></button></div></div>");
    } else {    
        document.querySelector("#shelf").insertAdjacentHTML( "beforeend" , "<div class=\"book\"><p class=\"author\">" + item.author + "</p><p class=\"title\">" + item.title + "</p><p class=\"pages\">" + item.pages + "</p><div class=\"btn\"><button><span class=\"material-symbols-outlined\">visibility_off</span></button><button class=\"delete\"><span class=\"material-symbols-outlined\">delete</span></button></div></div>");
    }
}
...
function updateLibrary() {
    if (readField === true) {
        document.querySelector("#shelf").insertAdjacentHTML( "beforeend" , "<div class=\"book\"><p class=\"author\">" + authorField + "</p><p class=\"title\">"+ titleField + "</p><p class=\"pages\">" + pagesField + "</p><div class=\"btn\"><button><span class=\"material-symbols-outlined\">visibility</span></button><button class=\"delete\"><span class=\"material-symbols-outlined\">delete</span></button></div></div>");
    } else {
